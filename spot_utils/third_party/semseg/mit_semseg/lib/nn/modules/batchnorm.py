...
class _SynchronizedBatchNorm(_BatchNorm):
    ...
    def _data_parallel_master(self, intermediates):
        """Reduce the sum and square-sum, compute the statistics, and broadcast
        it."""
    ...
    def _compute_mean_std(self, sum_, ssum, size):
        ...
        This method also maintains the moving average on the master
        device.
        """
        assert (
            size > 1
...
class SynchronizedBatchNorm1d(_SynchronizedBatchNorm):
    r"""Applies Synchronized Batch Normalization over a 2d or 3d input that is
    seen as a mini-batch.
